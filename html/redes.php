...
<body>
    ...
    <section id="title" class="emerald">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <h1><i class="fa fa-sitemap"></i> Especialidad en Redes</h1>
                    <p>Redes y Telecomunicaciones</p>
                </div>
                <div class="col-sm-6">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="btn-group">
                        <a class="btn btn-danger" href="#scroller" data-slide="prev"><i class="fa fa-chevron-left"></i></a>
                        <a class="btn btn-danger" href="#scroller" data-slide="next"><i class="fa fa-chevron-right"></i></a>
                    </div>
                    <p class="gap"></p>
                </div>
                <div class="col-md-9">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a id='button1id' name='button1id' class='btn btn-primary' href='descargas.php'><i class="fa fa-download"></i> Ir a Descargas</a>
    ...
    <script src="../js/funcion_mencion_redes.js"></script>
</body>
</html>